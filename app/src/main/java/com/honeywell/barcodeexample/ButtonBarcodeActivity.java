...
public class ButtonBarcodeActivity extends Activity implements BarcodeReader.BarcodeListener,
    ...
    private Button btnButtonBarcode;
    private boolean btnPressed=false;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buttonbarcode);
        ...
        if (barcodeReader != null) {
            ...
            btnButtonBarcode = (Button) findViewById(R.id.buttonScan);
            btnButtonBarcode.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        Logger.getLogger("ButtonBarcodeSample").log(Level.ALL, "Exception " + ex.toString());
                    }
                }
            });
        }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(
                        ButtonBarcodeActivity.this, android.R.layout.simple_list_item_1, list);
    ...
    public void onFailureEvent(BarcodeFailureEvent arg0) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                Toast.makeText(ButtonBarcodeActivity.this, "No data", Toast.LENGTH_SHORT).show();
            }
        });
    }
